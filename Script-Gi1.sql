...
INSERT INTO proyectorium.movie (id, title, duration, sinopsis, releaseDate, movieHour, provider_id, movieImage)
VALUES 
    (1, 'The Dark Knight', 152, 'Batman faces off against the Joker.', '2008-07-18', 'HOUR_16', 1, null),
    (2, 'Jurassic Park', 127, 'Dinosaurs are brought back to life with disastrous results.', '1993-06-11', 'HOUR_18', 2, LOAD_FILE('src/java/proyectorium/crud/resources/Jurassic_Park_(franchise_logo).png')),
    (3, 'Inception', 148, 'A thief enters the dreams of others to steal secrets.', '2010-07-16', 'HOUR_20', 3, null);
...
INSERT INTO proyectorium.user (id, email, fullName, password, city, companyId, user_type)
VALUES 
    (1, 'admin1@example.com', 'Admin One', 'WuLegi4p5enGK/cX0y9kZA==', 'City A', 'ADMIN', 'UserEntity'),
    (2, 'customer1@example.com', 'Customer One', 'WuLegi4p5enGK/cX0y9kZA==', 'City B', 'CUSTOMER', 'UserEntity');


-- Insertar datos en la tabla "ticket"
INSERT INTO proyectorium.ticket (id, buyDate, price, numPeople, movie_id)
VALUES 
    (1, '2025-01-10', 20.00, 2, 1),  -- "The Dark Knight" (2 people)
    (2, '2025-01-11', 12.00, 1, 2);  -- "Jurassic Park" (1 person)
